...
var ReviewBreakdown = ({ reviews, handleStarFilters, filters, setFilters }) => {
  ...
  return (
    <div className='reviewBreakdown'>
      <div>
        <h1>{ratingAvg}</h1>
        <StarRating rating={ratingAvg} classParam={'starBarAvg'}/>
      </div>
      ...
      <div className='starRatings1 starRatings' onClick={() => handleStarFilters(1)}>{'1 stars ' + ' '}<RatingBar rating={reviewMetaObj.ratings[1]} /><div id='rating-count'>{reviewMetaObj.ratings[1] || 0}</div> </div>
